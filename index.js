...
const ui=(data)=>{
          ...
          <div class="app-content">
            ...
            <div class="flex-button-container">
              <button class="button button-large">
                <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="snowflake" class="color-cool"
              ...
              <button class="button button-large">
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="fire-alt" class="color-warm"
                  role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  <path fill="currentColor"
    ...
    document.getElementById("wether_ui").innerHTML=p
}


const wether=()=>{
    let city=document.getElementById("city").value
    fetch(`http://api.openweathermap.org/data/2.5/weather?q=${city},uk&APPID=1636f161d7ef9e3e583b6dc2f039d33b`)
    .then((res)=>res.json())
    .then((data)=>{ui(data)    })
}
